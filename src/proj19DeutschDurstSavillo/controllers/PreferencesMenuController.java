...
public class PreferencesMenuController {
    ...
    public PreferencesMenuController(MenuItem initialSelectedMenuItem){
        ...
        this.preferenceWritingPath = "proj19DeutschDurstSavillo/resources/ColorPreferences.css";
    ...
    /**
     * Get the action that the user chose and execute the correct method
     * @param event
     */
    public void handlePreferencesMenuAction(ActionEvent event){
        ...
        switch (lastPressedMenuItem.getId()) {
            ...
            case "darkThemeMenuItem":
                loadTheme("/proj19DeutschDurstSavillo/resources/DarkTheme.css");
                break;
            default:
        }
     ...
     */
    public void loadTheme(String themeCSS){
