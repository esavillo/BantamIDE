...
public class Location
{
    ...
    {
        if (!inMemory) { throw new RuntimeException("Location is not in memory"); }
        return baseReg;
    }
    ...
    {
        if (inMemory) { throw new RuntimeException("Location is in memory"); }
        return reg;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if (inMemory != l.inMemory) { return false; }
        if (inMemory) {
            if (!baseReg.equals(l.baseReg) || offset != l.offset) { return false; }
        } else {
            if (!reg.equals(l.reg)) { return false; }
        }
        return true;
    }
    ...
    {
        if (inMemory) { return "Memory address: " + offset + "(" + baseReg + ")"; } else { return "Register: " + reg; }
    }
}
