 ...
 public class Token
 {
     private static Set<String> reservedWords = Collections.unmodifiableSet(
             new HashSet<>(Arrays.asList("alias", "break", "cast", "class", "var",
                                         "else", "extends", "for", "if", "instanceof", "new",
                                         "return", "while", "Lambda", "Array")));
     //instance variables
     public Kind kind;
     ...
     public enum Kind
     {
         ...
         // reserved words
         ALIAS, BREAK, CAST, CLASS, VAR, ELSE, EXTENDS, FOR, IF, INSTANCEOF, NEW,
         RETURN, WHILE,
